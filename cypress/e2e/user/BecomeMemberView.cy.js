describe("Become a Member Page", () => {
  ...
  it("should render the Become a Member page content", () => {
    ...
    cy.get("h1")
      .contains("Become a Member – Support Soppidentifikasjon.no!")
      .should("exist"); // Ensure the title is visible
    ...
    cy.get('[data-testid="become-member-button"]').should(
      "have.attr",
      "href",
      "https://portal.smartorg.no/action/reg/7fd64a16",
    );
  });
  ...
  it("should display the correct content based on language change", () => {
    ...
    cy.get("h1")
      .contains("Become a Member – Support Soppidentifikasjon.no!")
      .should("exist"); // Ensure title is visible in English
    ...
    cy.get("h1")
      .contains("Bli medlem – Støtt Foreningen for Tryggere Ruspolitikk!")
      .should("exist"); // Ensure title is visible in Norwegian
  });
