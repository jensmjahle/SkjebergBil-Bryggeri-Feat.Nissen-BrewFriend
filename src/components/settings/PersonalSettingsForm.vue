  ...
  <div class="space-y-6">
    ...
    <div>
      ...
      <p class="text-text2-faded">
        {{ t("settings.personal.changePasswordSubtitle") }}
      </p>
    </div>
    ...
    <p v-if="passwordMismatch" class="text-danger text-sm">
      {{ t("errors.passwordMismatch") }}
    </p>
    <p v-if="invalidPasswordFormat" class="text-danger text-sm">
      {{ t("errors.invalidPasswordFormat") }}
    </p>
    <p v-if="missingOldPassword" class="text-danger text-sm">
      {{ t("errors.missingOldPassword") }}
    </p>
...
import {
  ...
  updateAdminProfile,
  changeAdminPassword,
} from "@/services/rest/adminService.js";
